...
import {useModals} from '../../../src/internal/context/Modals/ModalContext.js'
import {ThemeProvider} from '../../../src/internal/styles/ChakraThemeProvider.js'
import {IFormProps, IJaenTemplate} from '../../../src/types.js'
import {dirtyValues} from '../../../src/utils/forms/dirtyValues.js'
    ...
    <>
      ...
      <form
        ...
        <Stack boxSize="full" spacing="8">
          ...
          <ButtonGroup isDisabled={!isDirty} mt="8" size="md">
            <Button
              variant="outline"
            ...
            <Button onClick={onReset} variant="ghost" color="red">
              Cancel
            </Button>
          </ButtonGroup>
        </Stack>
